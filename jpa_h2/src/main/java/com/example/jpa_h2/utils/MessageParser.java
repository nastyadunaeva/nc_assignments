package com.example.jpa_h2.utils;

import com.example.jpa_h2.controller.StockController;
...
public class MessageParser {
    public static void getPrices(String message) {
        ...
        for (String s: strings) {
            ...
            if (StockController.cache != null) {
                synchronized (StockController.cache) {
                    StockController.cache.put(ticker, price);
                }
            }
